...
## Pack
All files under this folder restyled to match. Draw sizes unchanged (64 / 96 / 64×96).
Coder: re-push `client/assets/` from this pack (supersedes PR #10 painterly/flat passes).
