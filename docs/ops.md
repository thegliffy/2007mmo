...
| 7 | Hard-refresh the site | Ctrl+Shift+R / Cmd+Shift+R. `index.html` pins `app.js?v=ad-hamlet` |
...
```
script src="app.js?v=ad-hamlet"
script src="sprites.js?v=ad-hamlet"
script src="pick-npc.js?v=ad-hamlet"
```
